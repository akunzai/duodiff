...
/// TTY-handoff call order without touching a real terminal — the recording counterpart to
/// `crate::actions::RealTerminalHandoff` (and to `RedirectedConfigDir`'s env-var restore).
